...
summary1_robust = summary1.query('lake_height_std < 30 & lake_observation_count > 25 & unique_dates_count > 4')

# !!! Picked 108 lakes from the 323 lakes which meet the threshold. 
...
map_ID = '3231'
shape = gr_lakes.query('LakeID == 3231')
points = robust_lake_pts.query('LakeID == 3231')
